class FamilyMembersController < ApplicationController
  ...
  before_action :set_families, only: [:new, :create, :edit, :update]
  ...
  def set_families
    ...
    def family_member_params
      params.require(:family_member).permit(:family_member_login, :password, :password_confirmation, :name, :surname,
                                            :middle_name, :family_admin, :family_id)
    end
end
